      ...
      <ul class="layui-nav layui-layout-right">
        ...
        <li class="layui-nav-item layuimini-setting">
          ...
          <dl class="layui-nav-child">
            <dd>
              <a href="javascript:;" class="basicInfo" data-title="基本资料" data-icon="fa fa-gears">基本资料<span class="layui-badge-dot"></span></a>
            </dd>
            <dd>
              <a href="javascript:;" class="changePwd" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
            </dd>
            <dd>
              <hr>
            </dd>
...
<script>
  layui.use(['jquery', 'layer', 'miniAdmin','miniTongji','miniTab','form'], function () {
    var $ = layui.jquery,
            layer = layui.layer,
