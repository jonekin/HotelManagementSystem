...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/layui_ext/dtree/font/dtreefont.css" media="all">
</head>
<body>
    ...
    layui.extend({
        ...
        var tableIns = table.render({
            ...
            cols: [[
                ...
                {field: 'href', minWidth: 220, title: '菜单地址', align: "center"},
                {field: 'spread', Width: 80, title: '是否展开', align: "center",templet:function (d) {
                        return d.spread == 1 ? "<font color='red'>是</font>":"<font color='black'>否</font>"
                    }},
                {field: 'icon', Width: 80, title: '菜单图标', align: "center",templet:function (d) {
        ...
        dtree.on("node(menuTree)",function (obj) {
            tableIns.reload({
                where:{
                    "id":obj.param.nodeId//nodeId属性就是选中节点的id值
                },
                page: {curr: 1}
            })
        });
