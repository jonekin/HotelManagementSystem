                    ...
                    <div class="layui-row layui-col-space10">
                        ...
                        <div class="layui-col-md3 layui-col-xs5">
                            <div class="layui-upload-list thumbBox mag0 magt3">
                                <input type="hidden" name="photo" id="photo" value="/hotel/show/images/defaultimg.jpg">
                                <img class="layui-upload-img thumbImg" src="images/defaultimg.jpg">
                            </div>
                        </div>
                    </div>
...
<script>
    layui.use(['form', 'table', 'laydate', 'jquery', 'layer','upload','layedit'], function () {
        ...
        upload.render({
            elem: ".thumbImg",//绑定元素
            url: '/admin/file/uploadFile',//文件上传的地址
