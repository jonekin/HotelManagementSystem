      ...
      <div style="margin: 10px 10px 10px 10px">
        <form class="layui-form layui-form-pane" action="">
          <div class="layui-form-item">
            ...
            <div class="layui-inline">
              <button type="submit" class="layui-btn"  lay-submit lay-filter="data-search-btn"><i class="layui-icon layui-icon-search">搜 索</i></button>
              <button type="reset" class="layui-btn layui-btn-warm"><i class="layui-icon layui-icon-refresh-1">重 置</i></button>
            </div>
          </div>
        </form>
      </div>
...
<script>
  layui.use(['form', 'table','layer'], function () {
    ...
    function deleteById(data){
      //判断当前部门下是否存在员工
      $.get("/admin/dept/checkEmployee",{"id":data.id},function (result) {
        if(result.exist){
          //提示用户无法删除
          layer.msg(result.message);
        }else {
